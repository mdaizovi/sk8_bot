...
class SlackMessageFactory(MessageProducer):
    ...
    def _get_broadcast_message(self):
        ...
        broadcast_msg = self._get_broadcast_message(sender, text)
...
class TelegramMessageFactory(MessageProducer):
    ...
    def _get_broadcast_message(self):
        message_list = _self.get_message_string.split()
    ...
    def _send_output(self, output_target, output_content):
        has_image_extension = [True for ext in ["jpg", "png", "gif"] if output_content.endswith(".{}".format(ext))]
